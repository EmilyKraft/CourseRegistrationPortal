									...
									<div class="panel-body">
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<c:out value='${successNewCourseMsg}' />

												<div class="m-t-20">
													<form:form action="createNewCourse"
														modelAttribute="newCourse" method="post">
														<div class="form-group">
															<label>Course Title</label>
															<form:input type="text" class="form-control"
																required="true" placeholder="Enter course title"
																path="courseTitle" />
														</div>
														...
														<div class="form-group">
															<label>Price</label>
															<div>
																<form:input data-parsley-type="number" type="text"
																	class="form-control" required="true"
																	placeholder="Enter only numbers" path="price" />
															</div>
														</div>
														<div class="form-group">
															<label>Skillset</label>
															<form:input type="text" class="form-control" required="true"
																placeholder="Enter skillset" path="skillset" />
														</div>
														<div class="form-group">
															<label>Course Description</label>
															<div>
																<textarea required="true" class="form-control" rows="5"
																	path="courseDescription"></textarea>
															</div>
														</div>
														<div class="form-group">
															<div>
