                ...
                <div class="content">
                    ...
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">View Upcoming Enrollments</h4>
                        </div>
                    </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><c:out value="${enrollment.courseOffering.streetAddress}, ${enrollment.courseOffering.city}, ${enrollment.courseOffering.state} ${enrollment.courseOffering.zip}"/></td>
																<td class="text-center"><c:out value="${enrollment.courseOffering.courseTime}"/></td>
																<form action="cancelUserEnrollment" method="post">
																<input type="hidden" name="enrollmentID"
															value="${enrollment.enrollmentID}" class="form-control"/>
                                                                <td class="text-center"><button type="submit" class="btn btn-danger btn-rounded waves-effect waves-light m-t-15">Cancel enrollment</button></form></td>
                                                            </tr>
                                                            </c:forEach>
                                                            </tbody>
                                                        </table>
