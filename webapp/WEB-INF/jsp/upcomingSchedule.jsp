...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Course Registration System - Upcoming Courses </title>
                                                    ...
                                                    <section id="cd-timeline" class="cd-container">
														...
														<div class="cd-timeline-block">
                                                            ...
                                                            <div class="cd-timeline-content">
                                                                <h3>${courseOffering.course.courseTitle}</h3>
                                                                <p>${courseOffering.streetAddress}</p>
                                                                <p>${courseOffering.city}, ${courseOffering.state} ${courseOffering.zip}</p>
                                                                
                                                                <form action="sendReminder" method="get">
                                                                <input type="hidden" name="courseOfferingID"
															value="${courseOffering.courseOfferingID}" class="form-control"/>
																<button type="submit" class="btn btn-info btn-rounded waves-effect waves-light m-t-15">Send reminder</button>
																</form>
																
																<form action="cancelCourseOffering" method="get">
                                                                <input type="hidden" name="courseOfferingID"
															value="${courseOffering.courseOfferingID}" class="form-control"/>
																<button type="submit" class="btn btn-danger btn-rounded waves-effect waves-light m-t-15">Cancel course</button>
                                                                </form>
                                                                <span class="cd-date">${courseOffering.dateOffered} - ${courseOffering.courseTime}</span>
