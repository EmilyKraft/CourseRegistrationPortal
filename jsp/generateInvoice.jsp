...
<!-- Start right Content here -->
		...
		<div class="content-page">
			...
			<div class="content">
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<c:out value="${noEnrollmentsMsg}"/>
												<c:out value="${duplicateMsg}"/>

												<div class="m-t-20">
													<form:form class="" action="createNewInvoice"
														modelAttribute="newInvoice" method="post">
				...
				<footer class="footer"> © 2017 State of Missouri - All Rights Reserved. </footer>
